  ...
  return (
    <div className={classes.root}>
      <FormControl component="fieldset" className={classes.formControl}>
        <FormLabel component="legend">What tools would help you flourish today?</FormLabel>
        <FormGroup>
          <FormControlLabel
            control={<Checkbox checked={pomodoro} onChange={handleChange} name="pomodoro" />}
          ...
          />
          <FormControlLabel
            control={<Checkbox checked={stretch} onChange={handleChange} name="stretch" />}
